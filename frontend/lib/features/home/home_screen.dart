      ...
      children: [
        ...
        _stagger(
            ...
            _ActionPriorityCard(
              ...
              items: [
                ...
                AppStrings.get('sub_rne', l),
                AppStrings.get('sub_patente', l),
              ],
        ...
        _stagger(
            ...
            _ActionPriorityCard(
              ...
              categoryId: 'taxation',
              items: [
                AppStrings.get('sub_tva', l),
                AppStrings.get('sub_declaration', l),
                AppStrings.get('sub_quitus', l),
              ],
              consultLabel: AppStrings.get('consult_all', l),
            )),
        const SizedBox(height: 12),
        ...
        _stagger(
            ...
            _ActionPriorityCard(
              ...
              items: [
                AppStrings.get('sub_cnss', l),
                AppStrings.get('sub_cnam', l),
                AppStrings.get('sub_retraite', l),
              ],
              consultLabel: AppStrings.get('consult_all', l),
            )),
      ],
      ...
      child: Row(
        children: filters.map((f) {
          return Padding(
            ...
            child: InkWell(
              onTap: () => context.push(RoutePaths.categoryProcedures(f.$4)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Material(
          ...
          child: InkWell(
              onTap: () =>
                  context.push(RoutePaths.categoryProcedures(categoryId)),
...
class _SubItem extends StatelessWidget {
  const _SubItem({required this.label, required this.color});
  final String label;
  final Color color;
...
class _QuizLaunchCard extends StatelessWidget {
  const _QuizLaunchCard({required this.locale});
  ...
  Widget build(BuildContext context) {
    final title =
        locale == 'en' ? 'Admin readiness quiz' : 'Quiz administratif';
    final subtitle = locale == 'en'
        ? 'Answer 5 quick questions before going to the counter.'
        : '5 questions rapides avant de passer au guichet.';
    final action = locale == 'en' ? 'Start' : 'Commencer';
