          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                Builder(
                  builder: (context) {
                    final cost = procedure.summary.estimatedCost.trim();
                    final isFree = cost == '0 TND' || cost == '0.0 TND' || cost == '0,0 TND' || cost == '0';
                    return _SummaryPill(
                      icon: Icons.payments_rounded,
                      label: isFree ? 'Sans frais' : procedure.summary.estimatedCost,
                      isSuccess: isFree,
                    );
                  }
                ),
...
class _SummaryPill extends StatelessWidget {
  const _SummaryPill({required this.icon, required this.label, this.isSuccess = false});
  ...
  @override
  Widget build(BuildContext context) {
    final color = isSuccess ? AppTheme.olive : Theme.of(context).colorScheme.primary;
    final bgColor = isSuccess ? AppTheme.olive.withOpacity(0.12) : Theme.of(context).colorScheme.primary.withOpacity(0.08);
